					...
					e.prototype.parse=function(e)
					{
									...
									if(typeof e!="object"){
										...
										if(e.data.length===0)
										{
											...
											this.context.nextUrl="",e.pagination!=null&&(this.context.nextUrl=e.pagination.next_url);
												...
												if(this.options.template!=null&&typeof this.options.template=="string")
												{
													...
													else for(T=0,k=m.length;T<k;T++)
													{
														...
														if(typeof p!="object")
															...
															new Error(o);v=p.url,l=window.location.protocol.indexOf("http")>=0,
														l&&!this.options.useHttp&&(v=v.replace(/https?:\/\//,"//")),g.src=v,
														this.options.links===!0?(t=document.createElement("a"),
															t.href=h.link,
															t.appendChild(g),u.appendChild(t)):u.appendChild(g)
													}
					...
					e.prototype._buildUrl=function()
													{
														...
														n+="&callback=instafeedCache"+this.unique+".parse",n
													},
